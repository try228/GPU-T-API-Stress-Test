...
{
    public static void Run(CancellationToken hostCt, int durationSec, D3DTranslationLayer layer, GpuDeviceDescriptor? targetGpu)
    {
        ...
        DirectXRunner.LaunchPayload(selectedRuntime, "dx12", layer, targetGpu, durationSec, hostCt);
    }
}